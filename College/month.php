<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql2 = "SELECT C.Name, CC.CCid, DATE_FORMAT(I.Date, '%Y-%m') AS `year_month`, COUNT(I.CC_id) AS `count`
        ...
        GROUP BY C.Name, CC.CCid, `year_month`";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered mt-3" id="coursetable">
            <thead>
                <tr>
                    <th colspan="3"><center><?php echo $_SESSION['UserName']?>(Monthly) </center></th>

<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql2 = "SELECT C.Name, CC.CCid, YEAR(I.Date) AS year, COUNT(I.CC_id) AS count
                 ...
                 GROUP BY C.Name, CC.CCid, YEAR(I.Date)";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered mt-3" id="coursetable">
            <thead>
                <tr>
                    <th colspan="3"><center><?php echo $_SESSION['UserName']?>(Yearly) </center></th>

    ...
    <main class="mainbox" id="content">
        <?php
          ...
          //  session_start();
            ...
            echo '<form action="ratejob.php" method=post><table>
            <tr><th>Job  Name</th>
            <th>Rating</th></tr>
            <tr><td>'.$row1['Name'].'</td>
            ...
            <td><input type="submit" name="Rate" value="rate" class="update"></td></tr></table>
                ...
                echo "We regret to inform you that your Course has been removed. ";
            }
            }
            else{
                echo '<p><strong>Your Job is not mentioned in your profile</strong></p>';
            }
        ?>
    </main>
    <footer class="footer">

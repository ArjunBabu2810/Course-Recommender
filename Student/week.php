...
?>
    ...
    <div class="container mt-5">
    <h2 class="text-primary">Weekly Report</h2>
        <form action="" method="post">
        <div class="form-group">
                <label for="from">From</label>
            ...
            if(isset($_POST['submit'])){
                ...
                if($_POST['selection']=="college-course"){
                    echo '<table class="table table-striped" id="coursetable">
                            <thead>
                                <tr>
                                    <th colspan="5"><center>College Course Weekly Report From ('.$from.') To ('.$to.')</center></th>
                                </tr>
                                <tr>
                                    <th>College</th>
                                    <th>Course</th>
                    ...
                    echo '<table class="table table-striped" id="coursetable">
                            <thead>
                                <tr>
                                    <th colspan="4"><center>College Weekly Report From ('.$from.') To ('.$to.')</center></th>
                    ...
                    echo '<table class="table table-striped" id="coursetable">
                            <thead>
                                <tr>
                                    <th colspan="4"><center>Course Weekly Report From ('.$from.') To ('.$to.')</center></th>
                    ...
                    echo '<table class="table table-striped" id="coursetable">
                            <thead>
                                <tr>
                                    <th colspan="4"><center>Job Weekly Report From ('.$from.') To ('.$to.')</center></th>
                    ...
                    echo '<table class="table table-striped" id="coursetable">
                            <thead>
                                <tr>
                                    <th colspan="3"><center>Student Weekly Report From ('.$from.') To ('.$to.')</center></th>
